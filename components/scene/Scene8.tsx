...
export default function Scene8() {
  ...
  return (
    <section className="min-h-screen w-full relative bg-[#111827] overflow-hidden transition-colors duration-1000">
      ...
      {!candleOff && (
        <div className="absolute top-16 left-1/2 -translate-x-1/2 text-center z-10 pointer-events-none w-full px-4">
          ...
          <p className="text-white bg-black/40 px-6 py-2 rounded-full backdrop-blur-sm inline-block font-medium">
            Teka-teki: Putar layarnya dan cari "Angin Ajaib" untuk matiin lilinnya! 🔍
          </p>
        </div>
      )}
      ...
      {candleOff && (
        <div ref={polaroidContainerRef} className="absolute inset-0 z-20 pointer-events-none flex items-center justify-center">
          
          {/* Kumpulan Polaroid (Ganti src dengan foto kalian) */}
          <div className="polaroid-final absolute top-10 left-10 md:top-20 md:left-32 bg-white p-3 pb-10 shadow-2xl rotate-[-15deg] w-40 md:w-56">
            <img src="/foto1.jpg" className="w-full aspect-square object-cover bg-gray-200" alt="Memori 1" />
            <p className="text-center font-handwriting text-gray-600 mt-2">Our First Date</p>
          </div>

          <div className="polaroid-final absolute bottom-20 left-5 md:bottom-32 md:left-40 bg-white p-3 pb-10 shadow-2xl rotate-[10deg] w-40 md:w-56">
            <img src="/foto2.jpg" className="w-full aspect-square object-cover bg-gray-200" alt="Memori 2" />
            <p className="text-center font-handwriting text-gray-600 mt-2">Sayangku 🥰</p>
          </div>

          <div className="polaroid-final absolute top-16 right-5 md:top-24 md:right-32 bg-white p-3 pb-10 shadow-2xl rotate-[20deg] w-40 md:w-56">
            <img src="/foto3.jpg" className="w-full aspect-square object-cover bg-gray-200" alt="Memori 3" />
            <p className="text-center font-handwriting text-gray-600 mt-2">Miss you</p>
          </div>

          <div className="polaroid-final absolute bottom-16 right-10 md:bottom-28 md:right-40 bg-white p-3 pb-10 shadow-2xl rotate-[-12deg] w-40 md:w-56">
            <img src="/foto4.jpg" className="w-full aspect-square object-cover bg-gray-200" alt="Memori 4" />
            <p className="text-center font-handwriting text-gray-600 mt-2">Always You</p>
          </div>

          {/* Teks Ucapan Utama di Tengah */}
          <div className="final-text bg-black/60 backdrop-blur-md px-10 py-8 rounded-3xl text-center border border-white/20 shadow-[0_0_50px_rgba(244,114,182,0.3)]">
            <h2 className="text-4xl md:text-6xl font-bold text-pink-400 mb-4 font-handwriting">
              Happy Birthday / Anniversary!
            </h2>
            <p className="text-gray-200 text-lg md:text-xl max-w-lg mx-auto">
